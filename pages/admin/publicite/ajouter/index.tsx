...
const AjouterPub: NextPage = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            await axios.post(`${process.env.NEXT_PUBLIC_BASE_URI}/publicites`, json, {
                headers: {
    ...
    return(
        <Layout
            links = {<><Link href='/admin/publicite'><a>Publicité</a></Link> / <Link href='#'><a>Ajouter</a></Link> </>} 
        >
            <div className={css.container_ajouter_publicite}>
                <CardContentPageAdmin
                    titleCard = 'Ajouter une publicité'
                    url = '#'
