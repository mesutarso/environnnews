...
const EditPublicite: NextPage<Iapublicite> = ({ 
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            console.log(json);
            await axios.put(`${process.env.NEXT_PUBLIC_BASE_URI}/publicites/${router.query.id}`, json, {
                headers: {
    ...
    return(
        <Layout
            links = {<><Link href='/admin/publicité'><a>Publicité</a></Link> / <Link href={`/admin/publicite/${router.query.id}`}><a>Détails</a></Link> /  <Link href='#'><a>Modifier</a></Link></>}
